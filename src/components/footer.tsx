    ...
    <footer className="bg-primary text-primary-foreground border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-primary-foreground/70">
              Elevating standards in vertical transportation since 1988.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-primary-foreground/70">
              ...
              <li>
                <a href="mailto:contact@aoyama.com" className="hover:text-primary-foreground transition-colors">contact@aoyama.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-primary-foreground/20 pt-8 text-center text-sm text-primary-foreground/70">
          <p>&copy; {new Date().getFullYear()} Aoyama Elevator Reimagined. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
